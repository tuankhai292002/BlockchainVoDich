...
const publicKey = keyPair.getPublic("hex"); //04719af634ece3e9bf00bfd7c58163b2caf2b8acd1a437a3e99a093c8dd7b1485c20d8a4c9f6621557f1d583e0fcff99f3234dd1bb365596d1d67909c270c16d64
...
setTimeout(() => {
	...
	JeChain.addTransaction(transaction);
    const transaction2 = new Transaction(publicKey, "046856ec283a5ecbd040cd71383a5e6f6ed90ed2d7e8e599dbb5891c13dff26f2941229d9b7301edf19c5aec052177fac4231bb2515cb59b1b34aea5c06acdef43", 500, 10);
	transaction2.sign(keyPair);
	sendMessage(produceMessage("TYPE_CREATE_TRANSACTION", transaction2));
	JeChain.addTransaction(transaction2);
    //JeChain.mineTransactions();
...
setTimeout(() => {
    ...
    console.log(JeChain.getBalance(publicKey));
}, 15000);
